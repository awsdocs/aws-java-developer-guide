...
htmlhelp_basename = 'AWSSDKforJavaDeveloperGuidedoc'
...
latex_documents = [
  (master_doc, 'AWSSDKforJavaDeveloperGuide.tex', project,
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'awssdkforjavadeveloperguide', project,
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'AWSSDKforJavaDeveloperGuide', project,
   author, 'AWSSDKforJavaDeveloperGuide', 'One line description of project.',
   'Miscellaneous'),
]
