...
htmlhelp_basename = 'AWSJavaDeveloperGuide'
...
latex_documents = [
  (master_doc, 'AWSJavaDeveloperGuide.tex', project,
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'awsjavadeveloperguide', project,
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'AWSJavaDeveloperGuide', project,
   author, 'AWSJavaDeveloperGuide', 'One line description of project.',
   'Miscellaneous'),
]
