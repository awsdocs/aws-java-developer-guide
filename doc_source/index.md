...
+ [Getting Started](getting-started.md)
   + [Basic setup to work with AWS services](signup-create-iam-user.md)
   ...
   + [Set up AWS temporary credentials and AWS Region for development](setup-credentials.md)
+ [Using the AWS SDK for Java](basics.md)
   ...
   + [Provide temporary credentials to the AWS SDK for Java](credentials.md)
...
+ [Security for the AWS SDK for Java](security.md)
   + [Data protection in AWS SDK for Java 1.x](security-data-protection.md)
